...
public class SignupThree extends JFrame implements ActionListener{
    ...
    JLabel l1,l2,card,number,carddetail,pin,pnumber,pindetail,services;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String facility = "";
        if(c1.isSelected()){ 
            facility = facility + " ATM Card";// multiple option is selected so we concatenate them with string
        }
        if(c2.isSelected()){ 
